...
const BLUE = "#096294";
const BLUE_DARK = "#074e76";
const BLUE_LIGHT = "#0a7bbf";
const BLUE_PALE = "#c8e8f5";
const BLUE_PALE2 = "#bcd9ee";

const activities = ["Skating", "Swimming", "Fitness", "Aquatics", "Drop-ins", "Classes"];

export default function TestBluePage() {
  ...
  return (
    <div className="relative overflow-hidden" style={{ minHeight: "calc(100vh - 3.5rem)" }}>
      ...
      <div style={{ position: "absolute", top: "-120px", right: "-100px", width: "500px", height: "500px", borderRadius: "50%", background: `radial-gradient(circle, ${BLUE_PALE} 0%, transparent 70%)`, opacity: 0.7, pointerEvents: "none" }} />
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-12 pt-16 pb-20 relative z-10">
        ...
        {/* Live tag */}
        <div className="inline-flex items-center gap-2 bg-white border border-gray-200 rounded-full px-4 py-1.5 mb-8 text-xs font-semibold shadow-sm" style={{ color: BLUE }}>
          <span className="w-2 h-2 rounded-full shrink-0" style={{ background: BLUE_LIGHT, animation: "heroPulseBlue 2s infinite" }} />
        ...
        <div className="flex items-center gap-4 flex-wrap">
          <Link
            href="/testblue/activities"
            className="flex items-center gap-2.5 text-white px-8 py-4 rounded-full text-base font-semibold transition-all hover:-translate-y-0.5"
            style={{ background: BLUE, boxShadow: `0 4px 20px rgba(9,98,148,0.30)` }}
          >
          ...
          <Link
            href="/testblue/activities?view=map"
            className="flex items-center gap-2.5 bg-transparent px-7 py-4 rounded-full text-base font-semibold border-2 transition-all"
        ...
        <div className="mt-14 flex items-center gap-5 flex-wrap">
          <div className="flex">
            {([BLUE_PALE, "#ffd6a5", BLUE_PALE2, "#f9c0c0"] as const).map((color, i) => (
              <div
                key={i}
          ...
          <div>
            <div className="text-sm font-bold" style={{ color: BLUE }}>33,000+ drop-in sessions</div>
            <div className="text-xs text-gray-500">across all Toronto districts</div>
          </div>
          <div className="w-px h-8 bg-gray-200" />
          <div>
            <div className="text-sm font-bold" style={{ color: BLUE }}>500+ facilities</div>
